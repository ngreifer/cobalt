...
#' @param ... other arguments that would be passed to \fun{bal.tab.formula}, \fun{bal.tab.data.frame}, or \fun{bal.tab.time.list}. See Details.
#' 
#' @return 
