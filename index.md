...
propensity score. *cobalt*’s primary function is
[`bal.tab()`](https://ngreifer.github.io/cobalt/reference/bal.tab.md),
which stands for “balance table”, and is meant to replace (or
supplement) the balance assessment tools found in other R packages. To
examine how
[`bal.tab()`](https://ngreifer.github.io/cobalt/reference/bal.tab.md)
integrates with these packages and others, see the help file for
[`bal.tab()`](https://ngreifer.github.io/cobalt/reference/bal.tab.md)
with
[`?bal.tab`](https://ngreifer.github.io/cobalt/reference/bal.tab.md),
...
used with the package. There are also several vignettes detailing the
use of *cobalt*, which can be accessed at
[`vignette("cobalt")`](https://ngreifer.github.io/cobalt/articles/cobalt.md):
one for basic uses of *cobalt*, one for the use of *cobalt* with
additional packages, one for the use of *cobalt* with multiply imputed
and/or clustered data, one for the use of *cobalt* with longitudinal
treatments, and one for the use of *cobalt* to generate
publication-ready plots. Currently, *cobalt* is compatible with output
from *MatchIt*, *twang*, *Matching*, *optmatch*, *CBPS*, *ebal*,
