---
title: "Appendix 2: Using cobalt with Multiply Imputed and Clustered Data"
author: "Noah Greifer"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette

vignette: >
  %\VignetteIndexEntry{Appendix 2: Using cobalt with Multiply Imputed and Clustered Data}
...
Setting `exact = ".imp"` requests that weights be estimated within each imputation seperately. Because this variable exists within the `w.out` object, we can simply refer to it by its name in the call to `bal.tab`.
...
To demonstrate, we will combine the approaches above by using the data sets with missingess that we imputed above but examining balance within each race group. 
