...
`r paste0("Greifer, N. (2018). cobalt: Covariate Balance Tables and Plots. R package version ", packageVersion("cobalt"), ".")`
...
Finally, we can use `love.plot()` to display balance across treatments. By default, `love.plot()` displays the values in the summary across pairwise comparisons. To request individual treatment comparisons, use `which.treat = NULL` in `love.plot()`.
