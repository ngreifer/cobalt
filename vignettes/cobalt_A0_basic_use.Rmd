...
> Matching was performed using the Matching package (Sekhon, 2011), and covariate balance was assessed using cobalt (Greifer, `r format(Sys.Date(), "%Y")`), both in R (R Core Team, 2018).
...
love.plot(m.out, stat = "mean.diffs", threshold = .1, binary = "std",
          var.order = "unadjusted", var.names = v, abs = TRUE,
          line = TRUE, limits = c(0, 1), grid = FALSE)
```
