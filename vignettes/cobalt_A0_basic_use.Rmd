...
See `?display_options` for the full list of display options. They can also be set as global options by using, for example, `options(cobalt_disp.means = TRUE)`, which allows user not to type a non-default options everytime they call `bal.tab`.
