...
The input is similar to that for using `bal.tab()` with `Matching` pr `optmatch`. One must specify either both a formula and a data set or both a treatment vector and a data frame of covariates.
