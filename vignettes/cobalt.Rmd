...
Greifer, N. (2016). cobalt: Covariate Balance Tables and Plots. R package version 1.3.1.
...
The following are some reasons why `cobalt` may be attractive to users of `MatchIt`, `twang`, `Matching`, `CBPS`, and `ebal`:
