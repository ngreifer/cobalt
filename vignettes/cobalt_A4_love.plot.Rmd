...
By setting `stars = "raw"`, asterisks appear next to the variables for which the raw idfference in means (i.e., proportions) is displayed, contradicting the axis title. In the figure's caption, you might write 
