...
#if (!rlang::is_installed("MatchIt")) knitr::opts_chunk$set(eval = FALSE)
```
...
You can install the development version of *cobalt* from [GitHub](https://github.com/ngreifer/cobalt) with:
...
Bugs appear in *cobalt* occasionally, often found by users. Please report any bugs at https://github.com/ngreifer/cobalt/issues.